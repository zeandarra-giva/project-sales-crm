        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto flex flex-col gap-4">
          <Card className="p-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Input
                ...
                placeholder="rsantos@company.ph"
                required
              />
              <Input
                label="Phone Number"
          ...
          <Card className="p-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Select
                label="Decision Rank"
                value={form.decision_rank}
                onChange={e => update('decision_rank', e.target.value)}
                options={DECISION_RANKS}
                required
              />
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs text-[#4a5068]">
                    {form.is_primary ? 'Yes – primary contact for this client' : 'No – secondary contact'}
                  </span>
                </div>
              </div>
            </div>
